      ...
      <div className={styles.workStagesContent}>
        ...
        <div className={`${styles.stages}  ${isDarkTheme ? styles.dark : styles.light}`}>
          ...
          <WorkStage isDarkTheme={isDarkTheme}
            ...
            title={"ПРОДАКШН"}
            text={
              "4.1 Создание моделей, анимация, текстурирование. озвучка. Согласование. 4.2 видео на основе видеосъемки: проведение постановчной видеосъемки. Монтаж. Оформление 2d/3d графикой. Согласование."
            }
          />
